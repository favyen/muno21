...
graph1 = pickle.load(open("global_dataset_mapbox_no_service_road/region_%s_graph_gt.pickle" % sys.argv[1], 'rb'))
graph2 = pickle.load(open("global_dataset_mapbox_no_service_road/region_%s_refine_gt_graph.p" % sys.argv[1], 'rb'))
